...
public class VhlAttributeInputImpl extends ASTWrapperPsiElement implements VhlAttributeInput {

  public VhlAttributeInputImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitAttributeInput(this);
  }
