...
public class VhlFixedTyImpl extends ASTWrapperPsiElement implements VhlFixedTy {

  public VhlFixedTyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitFixedTy(this);
  }
  ...
  @Override
  @Nullable
  public VhlFixedSignedTy getFixedSignedTy() {
    return findChildByClass(VhlFixedSignedTy.class);
  }

  @Override
  @Nullable
  public VhlFixedUnsignedTy getFixedUnsignedTy() {
    return findChildByClass(VhlFixedUnsignedTy.class);
  }
