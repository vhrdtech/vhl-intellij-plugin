...
public class VhlXpiAccessModeImpl extends ASTWrapperPsiElement implements VhlXpiAccessMode {

  public VhlXpiAccessModeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitXpiAccessMode(this);
  }
