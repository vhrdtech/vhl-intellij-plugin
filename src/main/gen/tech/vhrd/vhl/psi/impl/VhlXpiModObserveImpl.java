...
public class VhlXpiModObserveImpl extends ASTWrapperPsiElement implements VhlXpiModObserve {

  public VhlXpiModObserveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitXpiModObserve(this);
  }
