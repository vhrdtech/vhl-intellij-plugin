...
public class VhlXpiModStreamImpl extends ASTWrapperPsiElement implements VhlXpiModStream {

  public VhlXpiModStreamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitXpiModStream(this);
  }
