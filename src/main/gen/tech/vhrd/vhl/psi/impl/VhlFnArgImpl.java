...
public class VhlFnArgImpl extends ASTWrapperPsiElement implements VhlFnArg {

  public VhlFnArgImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public VhlTypeAscription getTypeAscription() {
    return findNotNullChildByClass(VhlTypeAscription.class);
  }
