...
public class VhlFloatingTyImpl extends ASTWrapperPsiElement implements VhlFloatingTy {

  public VhlFloatingTyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitFloatingTy(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getFloatTyImplicit() {
    return findNotNullChildByType(FLOAT_TY_IMPLICIT);
  }
