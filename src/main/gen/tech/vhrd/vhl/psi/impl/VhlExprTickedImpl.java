...
public class VhlExprTickedImpl extends ASTWrapperPsiElement implements VhlExprTicked {

  public VhlExprTickedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitExprTicked(this);
  }
