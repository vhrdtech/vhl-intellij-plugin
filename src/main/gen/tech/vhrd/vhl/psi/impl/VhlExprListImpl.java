...
public class VhlExprListImpl extends ASTWrapperPsiElement implements VhlExprList {

  public VhlExprListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<VhlExpr> getExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VhlExpr.class);
  }
