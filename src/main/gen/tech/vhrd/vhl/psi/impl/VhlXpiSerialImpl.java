...
public class VhlXpiSerialImpl extends ASTWrapperPsiElement implements VhlXpiSerial {

  public VhlXpiSerialImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitXpiSerial(this);
  }
  ...
  public PsiElement getDecLitRaw() {
    return findNotNullChildByType(DEC_LIT_RAW);
  }
