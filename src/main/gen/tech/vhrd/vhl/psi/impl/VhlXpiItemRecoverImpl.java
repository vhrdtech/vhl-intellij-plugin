...
public class VhlXpiItemRecoverImpl extends ASTWrapperPsiElement implements VhlXpiItemRecover {

  public VhlXpiItemRecoverImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitXpiItemRecover(this);
  }
