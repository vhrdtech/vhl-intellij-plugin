...
public class VhlFloatLitImpl extends ASTWrapperPsiElement implements VhlFloatLit {

  public VhlFloatLitImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getFloatLitRaw() {
    return findNotNullChildByType(FLOAT_LIT_RAW);
  }
