...
public class VhlUnitExprTickedImpl extends ASTWrapperPsiElement implements VhlUnitExprTicked {

  public VhlUnitExprTickedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitUnitExprTicked(this);
  }
