...
public class VhlNumBoundListImpl extends ASTWrapperPsiElement implements VhlNumBoundList {

  public VhlNumBoundListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitNumBoundList(this);
  }
  ...
  public VhlExprList getExprList() {
    return findNotNullChildByClass(VhlExprList.class);
  }
