...
public class VhlInnerAttrImpl extends ASTWrapperPsiElement implements VhlInnerAttr {

  public VhlInnerAttrImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public VhlAttribute getAttribute() {
    return findNotNullChildByClass(VhlAttribute.class);
  }
