...
public class VhlTextualTyImpl extends ASTWrapperPsiElement implements VhlTextualTy {

  public VhlTextualTyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitTextualTy(this);
  }
