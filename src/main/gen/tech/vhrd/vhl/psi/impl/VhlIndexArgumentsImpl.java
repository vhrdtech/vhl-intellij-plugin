...
public class VhlIndexArgumentsImpl extends ASTWrapperPsiElement implements VhlIndexArguments {

  public VhlIndexArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VhlVisitor visitor) {
    visitor.visitIndexArguments(this);
  }
